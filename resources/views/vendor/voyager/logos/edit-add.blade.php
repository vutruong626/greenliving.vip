...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.logos.update', $dataTypeContent->id) }}@else{{ route('voyager.logos.store') }}@endif"
