...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.sanphams.update', $dataTypeContent->id) }}@else{{ route('voyager.sanphams.store') }}@endif" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="loai_sanphams_id">{{ __('voyager::post.category') }}</label>
                                <select class="form-control" name="loai_sanphams_id">
                                    @foreach(App\Models\LoaiSanpham::all() as $category)
                                        <option value="{{ $category->id }}"@if(isset($dataTypeContent->loai_sanphams_id) && $dataTypeContent->loai_sanphams_id == $category->id) selected="selected"@endif>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
