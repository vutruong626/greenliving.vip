    ...
    <div class="top_panel_title_inner top_panel_inner_style_4  title_present_inner breadcrumbs_present_inner">
        <div class="content_wrap">
            ...
            <div class="breadcrumbs">
                ...
                <span class="breadcrumbs_item current">Sản phẩm</span>
            </div>
        </div>
    </div>
</div>
                        ...
                        element += '<li class="show_data_pro list_product product type-product post-2840 status-publish first instock product_cat-cough-cold-flu has-post-thumbnail shipping-taxable purchasable product-type-simple">' +
                                        '<div class="product-block" style="padding: 15px;">' +
                                            ...
                                            '<div class="caption">'+
                                                ...
                                                '</div>'+
                                                '<div class="opal-add-to-cart-button tooltipstered">'+
                                                    '<a data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="2840" data-product_sku="" style="font-size: 15px; text-decoration: none;"  rel="nofollow" href="{{ URL('/cart/add/','') }}/'+ res[i].id +'" >'+ 'Thêm vào giỏ hàng' + '&emsp;&emsp;<i class="fas fa-shopping-basket"></i>'+
                                                    '</a>'
                                                '</div>'+
