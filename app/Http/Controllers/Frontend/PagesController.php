...
class PagesController extends Controller
{
    ...
    public function getListProduct(Request $request, $idsp, $qty = 0)
    {
        ...
        return view('frontend.product.list_product', compact('category_faq','meta_description', 'cart_detail', 'gd_cordy', 'contact_munu', 'faq', 'contact', 'data', 'gd_cordy_list', 'total', 'logos', 'sliders', 'gioithieu', 'gd_cordy', 'news', 'clients', 'contents', 'about_us'));
    }
    /**
     * getindex
    ...
    public function getProduct($show_data)
    {
        ...
        if ($show_data == 0) {
            ...
            return Product::whereIn('category_id', $categorychild)->orderBy('id', 'DESC')->get();
        }
        return Product::where('category_id', $show_data)->get();
