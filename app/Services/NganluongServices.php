...
class NganluongServices
{
	...
	public $merchant_site_code = '59517'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	public $secure_pass= 'mhd@123'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
